...
docker run --restart unless-stopped -d -p 3000:3000 -v /var/lib/smart-home/grafana:/var/lib/grafana --net=smart-home --network-alias=grafana --name=grafana grafana/grafana

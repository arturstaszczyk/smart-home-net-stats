...
docker run -d -p 8086:8086 -v ~/Project/smart-home-net-stats/data/influx:/var/lib/influxdb --net=smart-home --network-alias=influxdb --name=influxdb smart-home-influx
sleep 10
